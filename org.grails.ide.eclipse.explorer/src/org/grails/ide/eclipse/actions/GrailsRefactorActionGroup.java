...
public class GrailsRefactorActionGroup extends ActionGroup {
	
	//Grails start: intercept creations of RenameAction
	private GrailsRenameAction newRenameAction(IWorkbenchSite site) {
		return new GrailsRenameAction(site);
	}
	private SelectionDispatchAction newRenameAction(JavaEditor editor) {
		return new GrailsRenameAction(editor);
	}
	//Grails end	
...
//	private SelectionDispatchAction fReplaceInvocationsAction;
	 ...
	 */
	public GrailsRefactorActionGroup(IViewPart part) {
	 ...
	 */
	public GrailsRefactorActionGroup(Page page) {
	 ...
	 */
	public GrailsRefactorActionGroup(JavaEditor editor, String groupName, boolean binary) {
		...
		if (!fBinary) {
			fRenameAction= newRenameAction(editor);
	 ...
	 * @since 3.4
	 */
	public GrailsRefactorActionGroup(IWorkbenchSite site, ISelectionProvider selectionProvider) {
		...
		if (!fBinary) {
			...
			fRenameAction= newRenameAction(fSite);
