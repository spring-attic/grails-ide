// COPIED_FROM org.eclipse.jst.jsp.ui.internal.wizard.NewJSPTemplatesWizardPage
/*******************************************************************************
...
/**
 * 
 * Copy from {@link NewJSPTemplatesWizardPage}Change to use {@link NewGSPTemplatesWizardPage} and use GSP-specific messages
 * @author Andrew Eisenberg
 * @created Nov 8, 2009
 * Templates page in new file wizard. Allows users to select a new file
 * template to be applied in new file.
 */
public class NewGSPTemplatesWizardPage extends WizardPage {
	...
	private class TemplateContentProvider implements IStructuredContentProvider {
		...
		public Object[] getElements(Object input) {
			return fStore.getTemplates("new_gsp");
		}
	...
	public NewGSPTemplatesWizardPage() {
		super("NewGSPTemplatesWizardPage", "Select a GSP Template", null); //$NON-NLS-1$
		setDescription("Select a template as initial content in the GSP page.");
	}
	...
	public void createControl(Composite ancestor) {
		...
		fUseTemplateButton.setText("&Use GSP Template");
		...
		fTemplateStore = GrailsGspEditorActivator.getDefault().getTemplateStore();
		fTableViewer.setInput(fTemplateStore);

		// Create linked text to just to templates preference page
		Link link = new Link(parent, SWT.NONE);
		link.setText("Templates are 'New GSP' templates found in the <a>GSP Templates</a> preference page.");
	...
	private String getPreferencePageId() {
		return "com.springsource.sts.gsp.editor.templates"; //$NON-NLS-1$
	}
	...
	String getTemplateString() {
		...
		Template template = getSelectedTemplate();
		if (template != null) {
			TemplateContextType contextType = GrailsGspEditorActivator.getDefault().getTemplateContextRegistry().getContextType("new_gsp");
	...
	private void setSelectedTemplate(String templateName) {
		...
		if (templateName != null && templateName.length() > 0) {
			...
			template = fTemplateStore.findTemplate(templateName, "new_gsp");
		}
