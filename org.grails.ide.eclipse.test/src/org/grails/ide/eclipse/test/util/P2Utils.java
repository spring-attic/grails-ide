 ...
 *******************************************************************************/
//This code was copied without modification from org.eclipse.jdt.internal.junit.buildpath.P2Utils
//Note: actually we are including the .class file already compiled instead of this source code, because
//tycho has problems compiling this file because of something that I think is probably a bug in how 
...
public class P2Utils {
	...
	public static BundleInfo findBundle(String symbolicName, VersionRange versionRange, boolean isSourceBundle) {
		System.out.println("P2Util: findBundle called: "+symbolicName+" "+versionRange+ " "+ isSourceBundle);
		Assert.isLegal(symbolicName != null);
		...
		if (manipulator == null) {
			System.out.println("P2Util: manipulator = null");
			return null;
		}
		...
		System.out.println("Bundle context = "+context);
		System.out.println("Bundle info path = "+bundleInfoPath);
		System.out.println("org.eclipse.equinox.simpleconfigurator.configUrl = " + System.getProperty("org.eclipse.equinox.simpleconfigurator.configUrl"));
		...
		System.out.println(">>> P2Util all bundles found");
