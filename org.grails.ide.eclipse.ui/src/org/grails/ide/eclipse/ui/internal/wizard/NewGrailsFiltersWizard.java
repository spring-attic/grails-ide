 ...
 * @since 2.6
 */
public class NewGrailsFiltersWizard extends GrailsCommandWizard implements INewWizard {

	public NewGrailsFiltersWizard() {
		super(CommandFactory.createCommandInstance(GrailsCommandFactory.CREATE_FILTERS));
	}
}
