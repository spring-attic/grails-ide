 ...
 */
public class NewGrailsIntegrationTestWizard extends NewGrailsTestWizard {

	public NewGrailsIntegrationTestWizard() {
		super(CommandFactory.createCommandInstance(GrailsCommandFactory.CREATE_INTEGRATION_TEST));
	}
