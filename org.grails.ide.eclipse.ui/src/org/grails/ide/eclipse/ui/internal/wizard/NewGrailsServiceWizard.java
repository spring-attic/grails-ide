 ...
 * @since 2.6
 */
public class NewGrailsServiceWizard extends GrailsCommandWizard implements INewWizard {

	public NewGrailsServiceWizard() {
		super(CommandFactory.createCommandInstance(GrailsCommandFactory.CREATE_SERVICE));
	}
