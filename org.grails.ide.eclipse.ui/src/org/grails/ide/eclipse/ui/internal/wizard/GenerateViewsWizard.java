 ...
 * @since 2.6
 */
public class GenerateViewsWizard extends GrailsCommandWizardOnDomainClass implements INewWizard {
	public GenerateViewsWizard() {
		super(CommandFactory.createCommandInstance(GrailsCommandFactory.GENERATE_VIEWS));
	}
}
